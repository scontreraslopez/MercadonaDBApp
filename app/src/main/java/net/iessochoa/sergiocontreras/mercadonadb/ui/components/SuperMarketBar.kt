...
// TODO mover esto Asegúrate de tener tu Enum definido en algún lado
enum class ShoppingStrategy {
    CHEAPEST, MOST_EXPENSIVE, BEST_VALUE, RANDOM
}
...
fun PreviewResultCardCheapest() {
    ...
    Column {
        ...
        ResultCard(product = sampleProduct.copy(name="Jamón Ibérico", price = 55.0), strategy = ShoppingStrategy.MOST_EXPENSIVE)
    }
}